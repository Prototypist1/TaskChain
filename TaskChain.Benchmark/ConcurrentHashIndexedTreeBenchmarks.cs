...
namespace Prototypist.TaskChain.Benchmark
{
    ...
    public class ConcurrentHashIndexedTreeBenchmarks
    {
        ...
        private ConcurrentIndexed<int, int> rawConcurrentHashIndexed;

        private ConcurrentIndexed<int, int> concurrentHashIndexedTree;
        private ConcurrentIndexed<HashTest, int> concurrentHashIndexedTree2;
